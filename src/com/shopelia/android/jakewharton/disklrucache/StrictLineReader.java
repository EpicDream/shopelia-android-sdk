...
package com.shopelia.android.jakewharton.disklrucache;
...
class StrictLineReader implements Closeable {
     ...
     * @param charset the charset used to decode data. Only US-ASCII, UTF-8 and
     *            ISO-8859-1 are supported.
     * @throws NullPointerException if {@code in} or {@code charset} is null.
     * @throws IllegalArgumentException if the specified charset is not
     *             supported.
     */
     ...
     * 
     * @throws IOException for errors when closing the underlying
     *             {@code InputStream}.
     */
