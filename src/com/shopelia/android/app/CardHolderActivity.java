...
public abstract class CardHolderActivity extends ShopeliaActivity {
	...
	public static final class AddCardEvent {
		...
		public AddCardEvent(String name, CardFragment card,
				boolean allowStateLoss, int index) {
			this.name = name;
			this.card = card;
	...
	public void addCard(CardFragment fragment, int index,
			boolean allowingStateLoss, String name) {
	...
	public void addCardNow(CardFragment fragment, int index,
			boolean allowingStateLoss, String name) {
		try {
