...
public class ImageRequest {
    ...
    public static final int CACHE_POLICY_LOCAL = CACHE_POLICY_MEMORY | CACHE_POLICY_DISK;
    public static final int CACHE_POLICY_DEFAULT = CACHE_POLICY_MEMORY | CACHE_POLICY_DISK | CACHE_POLICY_NETWORK;
